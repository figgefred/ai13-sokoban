...
public class HopcroftKarpMatching {
        ...
        public int maxBipartiteMatchCount(HashMap<BoardPosition, List<BoardPosition>> map, BoardState board)
        {
            return maxBipartiteMatch(map, board).size();
        }

        
        /*
	public HashMap<BoardPosition, BoardPosition> maxBipartiteMatch(HashMap<BoardPosition, List<BoardPosition>> map, BoardState board)
	{
		...
		return goal_pairings;
	}
         */
        
	/***
	 * Returns an hashmap mapping a block to a goal.
	 * @param map
	 * @return map
	 */
	public HashMap<BoardPosition, BoardPosition> maxBipartiteMatch(HashMap<BoardPosition, List<BoardPosition>> map, BoardState board)
